...
#import <react_native_ble_plx_swift/react_native_ble_plx_swift.h>
...
- (void)startTrackerScan:(NSArray<NSString *> * _Nullable)filteredUUIDs options:(NSDictionary<NSString *, id> * _Nullable)options;
- (void)startScaleScan:(NSDictionary<NSString *, id> * _Nullable)options;
- (void)activateVibration:(NSString * _Nonnull)deviceIdentifier duration:(NSInteger)duration transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)setTrackerDistanceUnit:(NSString * _Nonnull)deviceIdentifier unit:(NSString * _Nonnull)unit transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)setUserProfileToScales:(NSString * _Nonnull)deviceIdentifier age:(NSInteger)age height:(NSInteger)height gender:(NSString * _Nonnull)gender transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)setUserProfileToAlternativeScale:(NSString * _Nonnull)deviceIdentifier user:(NSString * _Nonnull)user age:(NSInteger)age height:(NSInteger)height gender:(NSInteger)gender transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)synchronizeAlternativeScale:(NSString * _Nonnull)deviceIdentifier user:(NSString * _Nonnull)user measurement:(NSString * _Nonnull)measurement transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)selectProfileAlternativeScale:(NSString * _Nonnull)deviceIdentifier user:(NSString * _Nonnull)user transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)setDeviceTime:(NSString * _Nonnull)deviceIdentifier date:(NSString * _Nonnull)date transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)setUserPersonalInfo:(NSString * _Nonnull)deviceIdentifier info:(NSDictionary<NSString *, id> * _Nonnull)info transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)getDetailedDayActivity:(NSString * _Nonnull)deviceIdentifier date:(NSInteger)date transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)getSummaryDayActivity:(NSString * _Nonnull)deviceIdentifier date:(NSInteger)date transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)monitorTrackerResponse:(NSString * _Nonnull)deviceIdentifier transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)monitorScaleResponse:(NSString * _Nonnull)deviceIdentifier transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)monitorAlternativeScaleResponse:(NSString * _Nonnull)deviceIdentifier transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
- (void)monitorAlternativeScaleFinalResponse:(NSString * _Nonnull)deviceIdentifier transactionId:(NSString * _Nonnull)transactionId resolve:(void (^ _Nonnull)(id _Nullable))resolve reject:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, NSError * _Nullable))reject;
...
SWIFT_CLASS("_TtC26react_native_ble_plx_swift12QNSDKManager")
@interface QNSDKManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


@interface QNSDKManager (SWIFT_EXTENSION(react_native_ble_plx_swift)) <QNBleDeviceDiscoveryListener>
@end
